...
fetch(`${api}people/1`)
    ...
    .then(function (data) {
        ...
        heightLuke.innerHTML = `height: <span>${data.height}cm`;
        skinLuke.innerHTML = `skin color: <span>${data.skin_color}`;
        birthLuke.innerHTML = `birth year: <span>${data.birth_year}`
        hairLuke.innerHTML = `hair color: <span>${data.hair_color}`
...
fetch(`${api}people/4`)
    ...
    .then(function (data) {
        ...
        heightVader.innerHTML = `height: <span>${data.height}cm`;
        skinVader.innerHTML = `skin color: <span>${data.skin_color}`;
        birthVader.innerHTML = `birth year: <span>${data.birth_year}`
        hairVader.innerHTML = `hair color: <span>${data.hair_color}`
...
fetch(`${api}people/5`)
    ...
    .then(function (data) {
        ...
        heightLeia.innerHTML = `height: <span>${data.height}cm`;
        skinLeia.innerHTML = `skin color: <span>${data.skin_color}`;
        birthLeia.innerHTML = `birth year: <span>${data.birth_year}`
        hairLeia.innerHTML = `hair color: <span>${data.hair_color}`
...
fetch(`${api}people/6`)
    ...
    .then(function (data) {
        ...
        heightOwen.innerHTML = `height: <span>${data.height}cm`;
        skinOwen.innerHTML = `skin color: <span>${data.skin_color}`;
        birthOwen.innerHTML = `birth year: <span>${data.birth_year}`
        hairOwen.innerHTML = `hair color: <span>${data.hair_color}`
...
fetch(`${api}people/7`)
    ...
    .then(function (data) {
        ...
        heightBeru.innerHTML = `height: <span>${data.height}cm`;
        skinBeru.innerHTML = `skin color: <span>${data.skin_color}`;
        birthBeru.innerHTML = `birth year: <span>${data.birth_year}`
        hairBeru.innerHTML = `hair color: <span>${data.hair_color}`
...
fetch(`${api}people/10`)
    ...
    .then(function (data) {
        ...
        heightObi.innerHTML = `height: <span>${data.height}cm`;
        skinObi.innerHTML = `skin color: <span>${data.skin_color}`;
        birthObi.innerHTML = `birth year: <span>${data.birth_year}`
        hairObi.innerHTML = `hair color: <span>${data.hair_color}`
...
fetch(`${api}films/1`)
    ...
    .then(function (data) {
        ...
        movieRelease.innerHTML = `release date: <span>${data.release_date}`;
        movieProducer.innerHTML = `rroducer: <span>${data.producer}`;
        movieDirector.innerHTML = `director: <span>${data.director}`;
        movieopening_crawl.innerHTML = `opening crawl: <span>${data.opening_crawl}`;
...
fetch(`${api}films/3`)
    ...
    .then(function (data) {
        ...
        movieTitle.innerHTML = `${data.title}`;
        movieRelease.innerHTML = `release date: <span>${data.release_date}`;
        movieProducer.innerHTML = `producer: <span>${data.producer}`;
        movieDirector.innerHTML = `director: <span>${data.director}`;
        movieopening_crawl.innerHTML = `opening crawl: <span>${data.opening_crawl}`;
...
fetch(`${api}species/1`)
    ...
    .then(function (data) {
        ...
        speciesClass.innerHTML = `classification: <span>${data.classification}`;
        speciesLifespan.innerHTML = `average lifespan: <span>${data.average_lifespan}`;
        speciesLanguage.innerHTML = `language: <span>${data.language}`;
        ...
        fetch(`${api}planets/9`)
            ...
            .then(function (data) {
                speciesHomeworld.innerHTML = `homeworld: <span>${data.name}`;
            })
...
fetch(`${api}starships/2`)
    ...
    .then(function (data) {
        ...
        starshipsManufacturer.innerHTML = `manufacturer: <span>${data.manufacturer}`;
        starshipsCost.innerHTML = `cost: <span>${data.cost_in_credits}`;
        starshipsCrew.innerHTML = `crew: <span>${data.crew}`;
        starshipsPassengers.innerHTML = `passengers: <span>${data.passengers}`;
